...
export default function Content({ sidebar }: { sidebar: boolean }) {
  return (
    <div
      ...
      <ContentSidebar />
      <div className='flex flex-col flex-grow text-white px-4'>
        <div className='text-lg font-semibold text-slate-200 mb-2'>Recents</div>
        <div className='grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 w-full max-w-[1500px] min-h-[200px] h-auto rounded-lg'>
